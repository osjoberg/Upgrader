...
namespace Upgrader.Test
{
    ...
    public abstract class PrimaryKeyInfoTest
    {
        ...
        {
            Database.Tables.Add("PrimaryKeyTableName", new[] { new Column("PrimaryKeyTableNameId", "int", ColumnModifier.PrimaryKey) });
        ...
        {
            Database.Tables.Add("PrimaryKeyName", new[] { new Column("PrimaryKeyNameId", "int") });
